...
export const categories = [
  { id: "fruits", name: "Fresh Fruits", emoji: "🍎", color: "from-red-500/30 to-amber-400/30" },
  { id: "veg", name: "Vegetables", emoji: "🥦", color: "from-rose-500/30 to-yellow-400/30" },
  { id: "dairy", name: "Dairy & Eggs", emoji: "🥛", color: "from-red-400/30 to-orange-400/30" },
  { id: "bakery", name: "Bakery", emoji: "🥐", color: "from-amber-400/30 to-red-500/30" },
  { id: "snacks", name: "Snacks", emoji: "🍿", color: "from-yellow-400/30 to-red-500/30" },
  { id: "drinks", name: "Beverages", emoji: "🥤", color: "from-orange-400/30 to-rose-500/30" },
  { id: "meat", name: "Meat & Fish", emoji: "🍗", color: "from-red-600/30 to-amber-300/30" },
  { id: "home", name: "Home Care", emoji: "🧴", color: "from-rose-400/30 to-amber-400/30" },
  { id: "baby", name: "Baby Care", emoji: "🍼", color: "from-red-500/30 to-amber-400/30" },
  { id: "pet", name: "Pet Care", emoji: "🐾", color: "from-rose-500/30 to-yellow-400/30" },
  { id: "frozen", name: "Frozen Foods", emoji: "🧊", color: "from-red-400/30 to-orange-400/30" },
  { id: "breakfast", name: "Breakfast", emoji: "🥣", color: "from-amber-400/30 to-red-500/30" },
  { id: "sweets", name: "Sweets & Mithai", emoji: "🍬", color: "from-yellow-400/30 to-red-500/30" },
  { id: "icecream", name: "Ice Cream", emoji: "🍦", color: "from-orange-400/30 to-rose-500/30" },
  { id: "tea", name: "Tea & Coffee", emoji: "🫖", color: "from-red-600/30 to-amber-300/30" },
  { id: "atta", name: "Atta, Rice & Dal", emoji: "🌾", color: "from-rose-400/30 to-amber-400/30" },
  { id: "spices", name: "Masala & Oils", emoji: "🧂", color: "from-red-500/30 to-amber-400/30" },
  { id: "instant", name: "Instant Food", emoji: "🍜", color: "from-rose-500/30 to-yellow-400/30" },
  { id: "beauty", name: "Beauty", emoji: "💄", color: "from-red-400/30 to-orange-400/30" },
  { id: "health", name: "Pharma & Wellness", emoji: "💊", color: "from-amber-400/30 to-red-500/30" },
  { id: "stationery", name: "Stationery", emoji: "✏️", color: "from-yellow-400/30 to-red-500/30" },
  { id: "electronics", name: "Electronics", emoji: "🎧", color: "from-orange-400/30 to-rose-500/30" },
  { id: "kitchen", name: "Kitchen", emoji: "🍳", color: "from-red-600/30 to-amber-300/30" },
  { id: "gifts", name: "Gifts & Party", emoji: "🎁", color: "from-rose-400/30 to-amber-400/30" },
];
