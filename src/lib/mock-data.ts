...
export const categories = [
  { id: "fruits", name: "Fresh Fruits", emoji: "🍎", color: "from-rose-400/30 to-amber-300/30" },
  { id: "veg", name: "Vegetables", emoji: "🥦", color: "from-emerald-400/30 to-lime-300/30" },
  { id: "dairy", name: "Dairy & Eggs", emoji: "🥛", color: "from-sky-300/30 to-indigo-300/30" },
  { id: "bakery", name: "Bakery", emoji: "🥐", color: "from-amber-300/30 to-orange-300/30" },
  { id: "snacks", name: "Snacks", emoji: "🍿", color: "from-yellow-300/30 to-red-300/30" },
  { id: "drinks", name: "Beverages", emoji: "🥤", color: "from-cyan-300/30 to-blue-300/30" },
  { id: "meat", name: "Meat & Fish", emoji: "🍗", color: "from-red-300/30 to-rose-300/30" },
  { id: "home", name: "Home Care", emoji: "🧴", color: "from-teal-300/30 to-emerald-300/30" },
  { id: "baby", name: "Baby Care", emoji: "🍼", color: "from-pink-300/30 to-fuchsia-300/30" },
  { id: "pet", name: "Pet Care", emoji: "🐾", color: "from-orange-300/30 to-amber-300/30" },
];
